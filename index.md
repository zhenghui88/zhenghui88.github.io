...
I am a Senior Engineer at the [Institute of Atmospheric Physics](http://www.iap.cas.cn/), [Chinese Academy of Sciences](http://www.cas.cn/).

My research focuses on:

- Regional Earth system model development;
- Physics-data integration;
- High-resolution hindcasting, nowcasting, and forecasting of droughts and floods over large domains.
...
1. Li, Kai; Zou, Liwei; Dan, Li; *Zheng, Hui*; Xu, Zhongfeng; Tang, Jianping; Yang, Fuqiang; Fei, Wenli; Zhang, Taotao; Shi, Chunxiang; & Yang, Zong-Liang\* (2025). The role of regional ocean–atmosphere coupling in simulating the 2020 extreme Mei-Yu event. *Advances in Atmospheric Sciences*, 42(5), 904–920. <https://doi.org/10.1007/s00376-024-4065-2>
1. Yang, Heng; Chen, Shuanglong; *Zheng, Hui*\* (2025). [Technical note: Drainage density-preserving river network delineation algorithm](https://github.com/zhenghui88/paper-2025-density-preserving-river-extraction). *Water*, 17(11), 1636. <https://doi.org/10.3390/w17111636>
1. Chen, Shuanglong; Yang, Heng; *Zheng, Hui*\* (2025). [Intercomparison of runoff and river discharge reanalysis datasets at the Upper Jinsha River, an alpine river on the eastern edge of the Tibetan Plateau](https://github.com/zhenghui88/paper-2025-upperjsj-streamflow-intercomp). *Water*, 17(6), 871. <https://doi.org/10.3390/w17060871>
...
1. Yang, Xi; Wei, Chong; Li, Zhiping; Yang, Heng; *Zheng, Hui*\* (2024). [A stream order family and order based parallel river network routing method](https://github.com/zhenghui88/paper-2024-stream-order-parallel-yangtze). *Water*, 16(14), 1965. <https://doi.org/10.3390/w16141965>
...
I am recruiting [Master's and PhD students](http://www.iap.cas.cn/gb/yjsjy_165427/dsjs) interested in land surface model development, sensitivity analysis, optimization, data assimilation, land–atmosphere interactions, and applications.
